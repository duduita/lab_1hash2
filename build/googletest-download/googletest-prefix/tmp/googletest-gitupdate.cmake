...
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" show-ref master
  WORKING_DIRECTORY "D:/Arquivos/Comp/CES-12/lab1hash200313_2221/build/googletest-src"
...
# yet).
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 master
  WORKING_DIRECTORY "D:/Arquivos/Comp/CES-12/lab1hash200313_2221/build/googletest-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Arquivos/Comp/CES-12/lab1hash200313_2221/build/googletest-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Arquivos/Comp/CES-12/lab1hash200313_2221/build/googletest-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
